            ...
            <b-notification v-show="demErrors" :active.sync="demErrorsActive"
              ...
              <div class="glbcontent">
                <Scene>
                  ...
                  <Asset :src="glbFile" v-if="glbFile && this.requestParams.format == 'glTF'"  :scaling="[0.02, 0.02, 0.02]" :position="[4, 0.5, 0]" @on-load="onLoad"></Asset>
...
export default {
  ...
  components: { MapRectangle,DatasetSelector,ImagerySelector,Asset,Camera, Scene, HemisphericLight },
  mounted() {
